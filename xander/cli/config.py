...
@click.option('-s', '--section', type = click.Choice(['all', 'access', 'firewall', 'interfaces', 'policies', 'routing', 'security', 'system', 'vlans']), help='Configuration Section To Render', required = False)
def build(device, vendor, section):
	...
	'''
	ROOT_DIR = os.getcwd()
	section_list = ['access', 'firewall', 'interfaces', 'policies', 'routing', 'security', 'system', 'vlans']
