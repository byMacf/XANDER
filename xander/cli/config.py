...
@click.option('-s', '--section', type = click.Choice(['all', 'interfaces', 'policies', 'protocols', 'security', 'system']), help='Configuration Section To Render', required = False)
def build(device, vendor, section):
	...
	'''
	ROOT_DIR = os.getcwd()
	section_list = ['interfaces', 'policies', 'protocols', 'security', 'system']
